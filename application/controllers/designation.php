...
class Designation extends MY_Controller {	
	...
	public function manage()
	{
		...
		$data['content'] = "$theme/designation/manage";
	...
	public function add_new()
	{
		...
		if(isset($_POST['submit']))
		{
			...
			$this->form_validation->set_rules('designation_name', 'Designation Name', 'trim|required');
                        $this->form_validation->set_rules('designation_salary', 'Designation Salary', 'trim|numeric|required');
			...
			if ($this->form_validation->run() != FALSE)
			{
				...
				$datai = array( 
						'designation_name' => $designation_name,
                                                 'designation_salary' => $designation_salary,
						'user_id' => $user_id,
						'entry_date' => $entry_time,
						);
				
				$branch_id=$this->Common_model->commonInsert('designation',$datai);
				...
				$_SESSION['msg'] = '<div class="alert alert-success alert-dismissable" style="margin-bottom:0px;">
							...
							';
				redirect('/designation/manage','location');	
		...
		$data['theme']=$theme;
		$data['content'] = "$theme/designation/add_new";
		$this->load->view("$theme/header",$data);
		//$data['sidebar'] = 'sidebar-left';		
