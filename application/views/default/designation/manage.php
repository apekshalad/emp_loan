                  ...
                  <table id="example2" class="table table-bordered table-hover">
                    <thead>
                      <tr>
						...
						<th width="250px" class="pad-right-5" >Designation Name</th>
						<th width="250px" class="pad-right-5" >Salary</th>
                    ...
                    {					
                		...
                		{ 	
                            ...
                            <tr>
                                ...
                                <td><?php echo  ucfirst($row->designation_name); ?></td>
                                <td><?php echo  ucfirst($row->designation_salary); ?></td>
        						
        						<td class="action_block">
        							<?php if($this->session->userdata('user_id') == 1) { ?>
        							<a href="<?php $segments = array('designation','delete',$row->id); 
