		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					echo form_open_multipart('report/profit_report',$attributes); ?>
        ...
        <section class="content">
		  ...
		  <div class="row">
            <div class="col-xs-12">
			  ...
			  <h2 class="page-header" style="text-align: center; border-bottom: 1px dashed rgb(238, 238, 238);">Profit Report</h2>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
					  ...
					  <th>Payment Mode</th>
					  <th>Interest Rate</th>
					  <th>Interest Amount (<i class="fa fa-money"></i>)</th>
				</tr>
              </thead>
              <tbody>
	<?php			$grand_total = 0;
					...
					{		
						...
						{ 
							$interest_amount = (($row->emi_amount * $row->interest_rate)/100);
						...
						?>	
							...
							<tr>
							  ...
							  <td><?php echo $interest_amount; ?></td>
							</tr>
