  ...
  <div class="content-wrapper">
		...
		<div class="row">
			<div class="col-md-12">
				<div class="box box-primary">
					...
					echo form_open_multipart('report/expenses',$attributes); ?>
        ...
        <section class="content">
		  ...
		  <div class="row">
            <div class="col-xs-12">
			  ...
			  <h2 class="page-header" style="text-align: center; border-bottom: 1px dashed rgb(238, 238, 238);">Expenses</h2>
            ...
            <table class="table table-striped">
              <thead>
                <tr>
					  ...
					  <th>Expenses Amount (<i class="fa fa-money"></i>)</th>
					  <th>Expense Mode</th>
                </tr>
              </thead>
              <tbody>
	<?php 
					$grand_total = 0;
						$n=1;
						$flag = false;
					if (isset($today_expenses_detail) && $today_expenses_detail->num_rows() > 0)
					{		
						$flag = true;
						foreach ($today_expenses_detail->result() as $row)
						{ 
							$grand_total += $row->payment_out; 
				...
				<?php	
					...
					{		
						...
						?>	
							...
							<tr>
							  <td><?php echo $n++; ?></td>
							  <td><?php echo date('m/d/Y',$row->loan_date); ?></td>
							  <td><?php echo "$row->loan_title Given."; ?></td> 
