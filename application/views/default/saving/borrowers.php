   ...
   $('#payment_mode').change(function() {
      ...
      <div class="content-wrapper">
        ...
        <section class="content">
			...
			echo form_open_multipart('saving/borrowers',$attributes); ?>
			...
			<!-- general form elements -->
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Borrower's Information</h3>
...
?>						
                      <tr>
						...
						<td class="action_block">
							...
							<a href="<?php $segments = array('saving','delete','borrowers',$myHelpers->EncryptClientId($row->cap_acc_id)); 
